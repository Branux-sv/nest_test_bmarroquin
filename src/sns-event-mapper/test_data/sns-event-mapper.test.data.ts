...
export const initSampleSesSnsEvent: SesSnsEvent = {
  Records: [
    {
      eventVersion: '1.0',
      ses: {
...
export const sampleTwoSesSnsEvent: SesSnsEvent = {
  Records: [
    {
      eventVersion: '1.0',
      ses: {
        receipt: {
          timestamp: '2015-01-11T20:32:33.936Z',
        ...
        mail: {
          timestamp: '2015-01-11T20:32:33.936Z',
          source: 'Jack_2025@example.com',
          messageId: 'd6iitobk75ur44p8kdnnp7g2n800',
          destination: [
            'recipient@example.com',
            'fake_user@contoso.com',
            'john_123@example2.com',
          ],
          headersTruncated: false,
          headers: [
            {
